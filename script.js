...
hamburger.addEventListener('click', () => {
    ...
    telegramBtn.classList.toggle('active');
});
...
document.querySelectorAll('.feature-card, .step, .testimonial-card, .about-text').forEach(el => {
    observer.observe(el);
});
...
document.addEventListener('click', (e) => {
    if (!hamburger.contains(e.target) && !navContent.contains(e.target) && !telegramBtn.contains(e.target)) {
        closeMobileMenu();
    }
});
...
console.log('Laulap landing page loaded successfully! 🚀');
